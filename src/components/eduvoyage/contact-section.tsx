...
export function ContactSection() {
  return (
    <section id="contact" className="scroll-mt-20 bg-white pb-12 sm:scroll-mt-24 sm:pb-16 md:pb-24">
        ...
        <div className="mt-8 overflow-hidden rounded-3xl bg-gradient-to-br from-edu-panel to-edu-sky-soft p-5 shadow-xl ring-1 ring-edu-navy/10 sm:mt-10 sm:rounded-[2.5rem] sm:p-8 md:p-10 lg:p-12">
          <div className="grid gap-10 sm:gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                <li className="flex min-w-0 items-start gap-3">
                  <span className="mt-0.5 grid h-9 w-9 shrink-0 place-items-center rounded-full bg-edu-navy text-white">
                    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <path d="M12 21s-7-4.5-7-11a7 7 0 1 1 14 0c0 6.5-7 11-7 11Z" strokeWidth="1.6" />
            ...
            <div className="min-w-0 rounded-2xl bg-white p-5 shadow-xl ring-1 ring-edu-navy/10 sm:rounded-[2rem] sm:p-8">
              <h3 className="text-lg font-bold text-edu-navy sm:text-xl">Send a Message</h3>
              <form className="mt-6 space-y-6 sm:mt-8 sm:space-y-8" action="#" method="post">
                <div>
                  <label className="text-sm font-semibold text-edu-navy" htmlFor="name">
                    Name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label className="text-sm font-semibold text-edu-navy" htmlFor="phone">
                    Phone number
                  </label>
                  <input
                    id="phone"
                ...
                <div>
                  <label className="text-sm font-semibold text-edu-navy" htmlFor="email">
                    E-mail
                  </label>
                  <input
                    id="email"
              ...
              <p className="mt-8 text-sm font-semibold text-edu-navy sm:mt-10">Follow us :</p>
